...
func NodeSpecFromPanel(nc *panel.NodeConfig) *NodeSpec {
	...
	return &NodeSpec{
		...
		ListenPorts:         nc.ListenPorts,
		Realm:               nc.Realm,
		RealmInsecure:       nc.RealmInsecure,
...
func (n *NodeSpec) ToPanel() *panel.NodeConfig {
	...
	return &panel.NodeConfig{
		...
		JLSUpstream:         n.JLSUpstream,
		ZeroRTT:             n.ZeroRTT,
		ALPN:                cloneStringSlice(n.ALPN),
